...
const socialLinks = [
  ...
  { 
    icon: Github, 
    href: 'https://github.com/RealHamzaAnjum/', 
    label: 'GitHub', 
...
const contactInfo = [
  { 
    icon: MapPin, 
    text: 'Comsats University Islamabad Sahiwal Campus',
    href: 'https://www.google.com/maps/place/COMSATS+University+Islamabad+-+Sahiwal+Campus+parking/@30.6443874,73.1498836,17z/data=!4m6!3m5!1s0x3922b72e000250bd:0xdd412a11bce497c!8m2!3d30.643449!4d73.147998!16s%2Fg%2F11sb0fqh8_?authuser=0&entry=ttu&g_ep=EgoyMDI1MTAxNC4wIKXMDSoASAFQAw%3D%3D' 
  },
  { 
    icon: Phone, 
    text: '+92 (323) 8582260',
    href: 'tel:+923238582260'
  },
  { 
    icon: Mail, 
    text: 'support@staybnb.com',
    href: 'mailto:support@staybnb.com' 
  },
];
